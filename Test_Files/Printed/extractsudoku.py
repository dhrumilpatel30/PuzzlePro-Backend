...
# current_image2 = cv2.imread("sudoku_test_image_4.jpg")
# image_list = split_digits(current_image2)
# current_image4 = cv2.imread("sudoku_test_image_5.jpeg")
# image_list = split_digits(current_image4)
# current_image4 = cv2.imread("sudoku_test_image_7.jpeg")
# image_list = split_digits(current_image4)
# current_image4 = cv2.imread("../Combined/sudoku_test_image_1.jpg")
# image_list = split_digits(current_image4)
# current_image4 = cv2.imread("../Combined/sudoku_test_image_2.jpg")
# image_list = split_digits(current_image4)
...
#         sudoku_matrix[row_index][col_index] = printed_digit_recognition_model(processed_image, digit_recognition_model)
#
